  ...
  return (
    <section className="rounded-3xl border border-gray-100 bg-white/95 p-5 shadow-sm">
      ...
      <div className="mt-3 grid gap-2 rounded-xl border border-gray-100 bg-gray-50 p-3 md:grid-cols-5">
        ...
        <input className="rounded-lg border border-gray-200 bg-white px-2 py-1.5 text-xs text-gray-900 placeholder:text-gray-400" placeholder="Price (e.g. R59)" value={props.newPlan.price} onChange={(e) => props.onNewPlanFieldChange("price", e.target.value)} />
